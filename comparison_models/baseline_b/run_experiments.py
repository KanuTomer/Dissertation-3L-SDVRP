...
from comparison_models.baseline_b.config import MODEL_NAME
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run baseline_b experiments across generated datasets.")
    ...
    for dataset_path in dataset_paths:
        ...
        for seed in range(args.start_seed, args.end_seed + 1):
            print(f"Running baseline_b seed {seed}", flush=True)
            cfg = {
                "dataset_path": str(dataset_path),
                "seed": seed,
            ...
            print(
                f"Completed baseline_b seed {seed} | "
