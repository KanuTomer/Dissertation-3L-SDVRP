...
from comparison_models.baseline_c.config import MODEL_NAME
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run baseline_c experiments across generated datasets.")
    ...
    for dataset_path in dataset_paths:
        ...
        for seed in range(args.start_seed, args.end_seed + 1):
            print(f"Running baseline_c seed {seed}", flush=True)
            cfg = {
                "dataset_path": str(dataset_path),
                "seed": seed,
            ...
            print(
                f"Completed baseline_c seed {seed} | "
